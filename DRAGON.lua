...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━• :\na•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━• :\na•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\n\27[0;33;49m')
...
io.write('\27[1;31m •━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
تم البرمجا بواسطة المبرمج ابوالمجد
~> DEVELOPER ↯ {text = @ABO_ELMAGD2
]])
...
token = sudos.token 
--- start functions •━═━═『𝙏𝙆𝙍𝙀𝙆  』═━═━•
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Aboelmagd2/SCKRAN/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1047777673,1853574370}   
...
if tonumber(user_id) == tonumber(1047777673) then  
var = true 
...
local UserName = (data.username_ or "xx03333")
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'تكريت') 
local DRAGON_Msg = { 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '😍صاحب السورس',url="t.me/A_S_VB"}}, 
{{text = 'المبرمج ابوالمجد', url="t.me/ABO_ELMAGD2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{'المطور','الاحصائيات'},
{'•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•'},
{'قسم صاحب السورس','قـسم مـسح&اضـف'},
...
local Text = ' ⌯︙تم ارسال الملصق من •━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/Aboelmagd2/SCKRAN/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx03333/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'قسم صاحب السورس' and DevSoFi(msg) then 
local Text = 'اضغط بالاسفل للدخول'
local Key = {
{'━┅┅┄⟞⟦ صاحب السورس ⟧⟝┄┉┉━'},
{'يا سورس','التواصل'},
...
send(msg.chat_id_, msg.id_,' ⌯︙ اصدار سورس تكريت{ 3x☆}')
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/A_S_VB/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┅┄⟞⟦𝙏𝙆𝙍𝙀𝙆⟧⟝┄┉┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس تكريت ادخل وتابع الجديد](t.me/xx03333)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ᴛᴋʀᴇᴋ', url="t.me/xx03333"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xx03333/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس تكريت ادخل وتابع الجديد](t.me/xx03333)
]] 
keyboard = {}  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xx03333/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/xx03333)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/xx03333"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ⌯︙ من أحسن السورسات على التليجرام سورس تكريت ⌯︙
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "تكريت")
...
send(msg.chat_id_,0," ⌯︙ الـعـضو  : {["..data.first_name_.."](T.ME/xx03333)}\n ⌯︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌯︙ عذرا  ⇇{["..data.first_name_.."](T.ME/xx03333)}\n ⌯︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╭━❲☆[𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐊𝐑𝐄𝐊](t.me/xx03333)☆❳━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙾𝚄𝚁𝙲𝙴 ᴛᴋʀᴇᴋ ](t.me/xx03333)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/xx03333)
╰━❲☆[𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐊𝐑𝐄𝐊](t.me/xx03333)☆❳━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
...
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐊𝐑𝐄𝐊', url="t.me/xx03333"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '& video=https://t.me/c/1184500541/104&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'علي' or text == 'تكريت' or text == 'صاحب السورس' then
local Text = [[
علي صاحب السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐴𝐿𝐼',url="t.me/A_S_VB"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/xx03333"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/A_S_VB&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'سكران' or text == 'ابوالمجد' or text == 'مبرمج السورس' then
local Text = [[
المبرمج ابوالمجد لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == '•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•' or text == 'قناة السورس' or text == 'زبهبن' then
local Text = [[
قناة سورس تكريت
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 ᴛᴋʀᴇᴋ', url="t.me/xx03333"}},
}
local msg_id = msg.id_/2097152/0.5
...
local TWEET_Msg = {
"جوز","ينطي____للماعده سنون",
"ضراطه","الي يسوق المطي يتحمل___",
"بيدك","اكل___محد يفيدك",
"الحافي","تجدي من___نعال",
"شقره","مع الخيل يا___",
"النخله","الطول طول___والعقل عقل الصخلة",
"سلايه","بالوجه امراية وبالظهر___",
"الخيل","من قلة___شدو على الچلاب سروج",
"حداد","موكل من صخم وجهه كال آني___",
"المبلل","___ما يخاف من المطر",
"الحبل","اللي تلدغة الحية يخاف من جرة___",
"يركص","المايعرف___يكول الكاع عوجه",
"العنب","المايلوح___يكول حامض",
"العمه","___إذا حبت الچنة ابليس يدخل الجنة",
"الخبز","انطي___للخباز حتى لو ياكل نصه",
"باحصاد","اسمة___ومنجله مكسور",
"شهر","امشي__ولا تعبر نهر",
"شكه","يامن تعب يامن__يا من على الحاضر لكة",
"القرد","__بعين امه غزال",
"يكحله","اجه___عماها",
}
send(msg.chat_id_, msg.id_,'['..TWEET_Msg[math.random(#TWEET_Msg)]..']')  
return false 
...
local Text = [[  
 ⌯︙ اهلا في قائمه الالعاب المتطوره سورس تكريت ⌯︙ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/xx03333)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1047777673) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع حظر صاحب السورس")
return false 
end
...
function(arg,data) 
usertext = '\n ⌯︙ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'xx03333')..')'
...
if result.id_ == tonumber(1047777673) then
...
usertext = '\n ⌯︙ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'xx03333')..')'
status  = '\n ⌯︙ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1047777673) then  
...
if tonumber(result.sender_user_id_) == tonumber(1047777673) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع كتم صاحب السورس ")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1853574370) then  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Aboelmagd2/SCKRAN/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⌯︙ اهلا بك في متجر ملفات تكريت\n ⌯︙ ملفات السورس •━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\n ⌯︙ علامة تعني { ✔️ } ملف مفعل\n ⌯︙ علامة تعني { ✖ } ملف معطل\n ⌯︙ قناة سورس تكريت•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\n".." ⌯︙ [اضغط هنا لدخول](t.me/xx03333) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Aboelmagd2/SCKRAN/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ⌯︙ عذرا الملف لايدعم سورس تكريت\n") 
end
return false
end
...
if text == ("مسح قائمه تكريت") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⌯︙ تم مسح قائمه تكريت')
return false
end

if text == 'قائمه تكريت' and Sudo(msg) then
...
if text == ("رفع تكريت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع تكريت@(.*)$") and Sudo(msg) then
local username = text:match("^رفع تكريت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع تكريت(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع تكريت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل تكريت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل تكريت@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل تكريت@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل تكريت(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل تكريت(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ⌯︙  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ⌯︙  الرفع  ⇇{ '..setadd..
' }\n'..' ⌯︙  الحظر  ⇇{ '..banm..' }\n\n ⌯︙═───═❲[ᴛᴋʀᴇᴋ ](t.me/xx03333)❳═───═ ⌯︙\n ⌯︙ قناة سورس تكريت•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\n [ ❲[ᴛᴋʀᴇᴋ ](t.me/xx03333)❳](t.me/xx03333) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•\nاضغط علي الاسم ليتم نسخه\n•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•ٴ\n ⌯︙ ❲[ᴛᴋʀᴇᴋ ](t.me/xx03333)❳ ⌯︙ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تكريت').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تكريت')
local ABO_ELMAGD2 = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
send(msg.chat_id_, msg.id_,'['..ABO_ELMAGD2[math.random(#ABO_ELMAGD2)]..']') 
return false
end
...
Namebot = ABO_ELMAGD2[math.random(#ABO_ELMAGD2)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨𝗦𝗢𝗨𝗥𝗖𝗘❩ ', url="t.me/xx03333"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
end --الكود حصري سورس تكريتيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تكريت').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..⌯︙♥️](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/xx03333)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤⌯︙](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..⌯︙💕](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/xx03333)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..⌯︙💕](t.me/xx03333)')
return false
end
end
end
...
local Text =[[
🚨 اهلا بك في قسم الاوامر ..↑•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•
 اختر الامر الذي تريدها .↑•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•
ده من الازرار بلاسفل . •━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[ᴛᴋʀᴇᴋ ](t.me/xx03333)❳ 
]]
keyboard = {} 
...
local Text = [[
🎮 اهلا بك في قسم الالعاب ..↑•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•
 اختر العبه الذي تريدها .↑•━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•
ده من الازرار بلاسفل . •━═━═『𝙏𝙆𝙍𝙀𝙆 』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[ᴛᴋʀᴇᴋ ](t.me/xx03333)❳ 
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تكريت')
